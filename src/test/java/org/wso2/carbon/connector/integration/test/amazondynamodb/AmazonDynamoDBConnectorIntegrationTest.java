...
public class AmazonDynamoDBConnectorIntegrationTest extends ConnectorIntegrationTestBase {
	 ...
	 * @throws IOException
	 */
	@Test(enabled = true, description = "amazondynamodb {createTable} integration test with mandatory parameters.")
	 ...
	 * @throws IOException
	 */
	@Test(enabled = true, description = "amazondynamodb {createTable} integration test with Optional parameters.")
	 ...
	 * @throws IOException
	 */
	@Test(enabled = true, dependsOnMethods = { "testCreateTableWithMandatoryParameters" },
	 ...
	 * @throws IOException
	 */
	@Test(enabled = true, dependsOnMethods = { "testCreateTableWithOptionalParameters",
